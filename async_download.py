...
def enqueueFilePathList(file_path_list, re_series_main, pool):    
    for file_path in file_path_list:
        pool.apply_async(retrieveFile, (host + file_path, str(re_series_main) + '-series'))
...
def main():
    ...
    for etsi_type in etsi_type_list:
        ...
        fetchAllFilesIntoQueue(etsi_type, pool)
